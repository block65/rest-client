...
type JsonifiableObject = { [key: string]: Jsonifiable };
...
export type UpdateBillingAccountCommandInput = BillingAccountUpdateRequest &
  UpdateBillingAccountCommandParams & { body: Uint8Array };
...
export type GetPaymentMethodFromStripeCommandInput = GetPaymentMethodFromStripeCommandParams;
...
export type ListBillingSubscriptionsCommandInput = ListBillingSubscriptionsCommandParams;
export type ListBillingSubscriptionsCommandBody = never;
export type CreateBillingSubscriptionCommandParams = {
  billingAccountId: string;
};
export type CreateBillingSubscriptionCommandInput = CreateBillingSubscriptionRequest &
  CreateBillingSubscriptionCommandParams;
export type CreateBillingSubscriptionCommandBody = CreateBillingSubscriptionRequest;
export type UpdateBillingSubscriptionCommandParams = {
  billingAccountId: string;
  subscriptionId: string;
};
export type UpdateBillingSubscriptionCommandInput = UpdateBillingSubscriptionRequest &
  UpdateBillingSubscriptionCommandParams;
export type UpdateBillingSubscriptionCommandBody = UpdateBillingSubscriptionRequest;
...
export type UpdateBillingSubscriptionPromoCodeCommandInput =
  UpdateBillingSubscriptionPromoCodeRequest & UpdateBillingSubscriptionPromoCodeCommandParams;
